...
const BlueprintCard: FC<ProductProps> = ({
  product,
  className = "",
  contactClassName = "",
  ...
  return (
    ...
    >
      ...
      >
        <h2
          className={cn("text-heading font-semibold mb-1", {
        ...
        >
          <span className="inline-block">Starts at: {price}</span>
          {discount && (
